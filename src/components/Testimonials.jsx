  ...
  <section id='clients' className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
    ...
    <div className='w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-16 relative z-[1] '>
      ...
      <div className="w-full md:mt-0 mt-6">
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus ipsam cupiditate aliquam hic dolor quisquam aperiam culpa, laborum voluptates ratione. Molestiae porro alias quas itaque incidunt voluptas et excepturi qui?
        </p>
      </div>
    </div>
